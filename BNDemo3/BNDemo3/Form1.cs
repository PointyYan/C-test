...
namespace BNDemo3
{
    public partial class Form1 : Form
    {
        ...
        {
            // TODO: 这行代码将数据加载到表“studentDataSet._class”中。您可以根据需要移动或删除它。
            this.classTableAdapter.Fill(this.studentDataSet._class);
            // TODO: 这行代码将数据加载到表“studentDataSet.studentinfo”中。您可以根据需要移动或删除它。
